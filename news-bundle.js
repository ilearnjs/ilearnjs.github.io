...
var MAIN_URL = 'https://newsapi.org/v2';
var SOURCES = 'sources';
var SOURCES_URL = MAIN_URL + '/' + SOURCES;
var HEADLINES = 'top-headlines';
var HEADLINES_URL = MAIN_URL + '/' + HEADLINES;
var APIKEY = '89b192969337425eb66621910ff1f9e8';

exports.SOURCES = SOURCES;
exports.SOURCES_URL = SOURCES_URL;
exports.HEADLINES = HEADLINES;
exports.HEADLINES_URL = HEADLINES_URL;
...
var Template = exports.Template = function () {
    ...
    _createClass(Template, [{
        ...
        key: '$if',
        value: function $if(condition, result) {
...
var _newsDataService = __webpack_require__(331);

var _newsRenderingService = __webpack_require__(334);

var _newsRoutingService = __webpack_require__(336);

var _newsConstants = __webpack_require__(89);

var routes = [{
    url: _newsConstants.SOURCES,
    action: function action() {
        _newsDataService.NewsDataService.getSources().then(function (sources) {
            return _newsRenderingService.NewsRenderingService.renderContent(sources, 'sources');
        }).catch(function (ex) {
            return alert(ex);
        });
    }
}, {
    url: _newsConstants.HEADLINES,
    action: function action(params) {
        _newsDataService.NewsDataService.getHeadlines(params).then(function (headLines) {
            return _newsRenderingService.NewsRenderingService.renderContent(headLines, 'headlines');
        }).catch(function (ex) {
            return alert(ex);
        });
    }
...
var routingService = new _newsRoutingService.NewsRoutingService(routes);
var route = function route() {
    return routingService.route(location.hash);
};
...
exports.NewsDataService = undefined;

var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();

var _newsConstants = __webpack_require__(89);

var _sourceModel = __webpack_require__(332);

var _headlineModel = __webpack_require__(333);

function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

// IE does not support URL
var NewsDataService = exports.NewsDataService = function () {
    function NewsDataService() {
        _classCallCheck(this, NewsDataService);
    }

    _createClass(NewsDataService, null, [{
        key: 'getSources',
        value: function getSources() {
            // const url = new URL(SOURCES_URL);

            var url = _newsConstants.SOURCES_URL;

            return this.request(url).then(function (json) {
                return json.sources.map(function (s) {
                    return new _sourceModel.Source(s);
                });
            });
        }
    }, {
        key: 'getHeadlines',
        value: function getHeadlines(params) {
            // const url = new URL(HEADLINES_URL);

            var url = _newsConstants.HEADLINES_URL;

            return this.request(url, params).then(function (json) {
                return json.articles.map(function (a) {
                    return new _headlineModel.Headline(a);
                });
            });
        }
    }, {
        ...
        value: function request(url) {
            ...
            Object.assign(params, { APIKEY: _newsConstants.APIKEY });
...
var _templateModel = __webpack_require__(90);
...
var Source = exports.Source = function (_Template) {
    _inherits(Source, _Template);
    ...
    _createClass(Source, [{
        key: "getHtml",
        value: function getHtml() {
            return "\n        <div class=\"source\">\n            <a\n                href=\"#" + _newsConstants.HEADLINES + "?sources=" + this.id + "\"\n                style=\"background-image:url(" + this.getSourceIconLink() + ")\" \n                title=\" " + this.name + "\">\n            </a>\n        </div>\n        ";
        }
    }, {
        key: "getSourceIconLink",
        value: function getSourceIconLink() {
...
var Headline = exports.Headline = function (_Template) {
    _inherits(Headline, _Template);

    function Headline(headline) {
        _classCallCheck(this, Headline);

        var _this = _possibleConstructorReturn(this, (Headline.__proto__ || Object.getPrototypeOf(Headline)).call(this));

        Object.assign(_this, headline);
        return _this;
    }
    ...
    _createClass(Headline, [{
        ...
        key: "getDateString",
        value: function getDateString(d) {
            var date = new Date(d);
...
exports.NewsRenderingService = undefined;

var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();

var _containerModel = __webpack_require__(335);

function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

var NewsRenderingService = exports.NewsRenderingService = function () {
    function NewsRenderingService() {
        _classCallCheck(this, NewsRenderingService);
    }

    _createClass(NewsRenderingService, null, [{
        key: 'renderContent',
        value: function renderContent(items, id) {
            this.clearContent();
            // IE does not support <template>
            // const container = new Container(id).getElement().firstElementChild;

            var container = new _containerModel.Container(id).getElement();
...
var Container = exports.Container = function (_Template) {
    _inherits(Container, _Template);
...
var NewsRoutingService = exports.NewsRoutingService = function () {
    function NewsRoutingService(routes) {
        _classCallCheck(this, NewsRoutingService);

        this.routes = routes;
    }

    _createClass(NewsRoutingService, [{
        key: 'route',
        value: function route(hash) {
            var parsedHash = this.parseHash(hash);
            var route = this.getRoute(parsedHash.routeUrl);
        ...
        key: 'getParams',
        value: function getParams(hashParams) {
            var params = {};
            (hashParams || '').split('&').forEach(function (p) {
                var keValue = p.split('=');
        ...
        key: 'getRoute',
        value: function getRoute(routeUrl) {
            return this.routes.find(function (r) {
                return r.url.toLowerCase() === routeUrl.toLowerCase();
            }) || this.routes[0];
        }
    }]);

    return NewsRoutingService;
}();
